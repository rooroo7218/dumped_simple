...
export const LoginScreen: React.FC<LoginScreenProps> = ({ signInWithGoogle }) => {
    return (
            ...
            <>
                ...
                <p className="text-sm text-slate-400 mb-4">Clear your head. Own your day.</p>
                    ...
                    <button
                        ...
                        className="w-full py-3.5 px-5 flex items-center justify-center gap-3 rounded-2xl border-2 border-slate-950 bg-white text-slate-800 text-[14px] font-semibold shadow-sm hover:bg-slate-50 transition-all active:scale-[0.98]"
                    >
