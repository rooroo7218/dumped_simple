            ...
            <div className="w-full max-w-sm mx-auto flex flex-col items-center gap-0 text-center">
                ...
                <div className="w-full space-y-3 mt-24">
                    ...
                    <button
                        ...
                        className="w-full py-4 px-6 flex items-center justify-center gap-3 rounded-2xl border-2 border-slate-950 bg-white text-slate-950 text-[15px] font-bold shadow-sm hover:bg-slate-50 transition-all active:scale-[0.98]"
                    >
