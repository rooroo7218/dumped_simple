...
export const DitheringShapes = { simplex: 1, warp: 2, dots: 3, wave: 4, ripple: 5, swirl: 6, sphere: 7 } as const
export const DitheringTypes = { random: 1, "2x2": 2, "4x4": 3, "8x8": 4 } as const
...
export function DitheringShader({
  width = "100%", height = "100%", colorBack = "#000000", colorFront = "#ffffff",
  shape = "simplex", type = "8x8", pxSize = 4, speed = 1, className = "", style = {},
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      gl.uniform4fv(locations.u_colorFront, hexToRgba(colorFront))
